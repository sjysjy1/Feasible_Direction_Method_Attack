...
from FDMA import FDMA_M1, FDMA_M2
import time
...
{'model':'Wong2020Fast','attack':'FDMA_M1','epsilon':8.0/255 ,'stepsize':0.007,'iter_max':20,'batch_size':batch_size,'div':1.0, 'beta':0.3,'rho': 0.99,'early_stop':False},
{'model':'Wong2020Fast','attack':'FDMA_M1','epsilon':16.0/255,'stepsize':0.007,'iter_max':20,'batch_size':batch_size,'div':1.0,'beta':0.3,'rho': 0.99,'early_stop':False},
{'model':'Wong2020Fast','attack':'FDMA_M1','epsilon':32.0/255,'stepsize':0.007,'iter_max':20,'batch_size':batch_size,'div':1.0,'beta':0.3,'rho': 0.99,'early_stop':False},
{'model':'Wong2020Fast','attack':'FDMA_M2','epsilon':8.0/255 ,'stepsize':0.007,'iter_max':20,'div':1.0,'beta':0.3,'rho': 0.99,'batch_size':batch_size,'early_stop':False},
{'model':'Wong2020Fast','attack':'FDMA_M2','epsilon':16.0/255,'stepsize':0.007,'iter_max':20,'div':1.0,'beta':0.3,'rho': 0.99,'batch_size':batch_size,'early_stop':False},
{'model':'Wong2020Fast','attack':'FDMA_M2','epsilon':32.0/255,'stepsize':0.007,'iter_max':20,'div':1.0,'beta':0.3,'rho': 0.99,'batch_size':batch_size,'early_stop':False},
...
{'model':'Wang2023Better','attack':'FDMA_M1','epsilon':8.0/255 ,'stepsize':0.007,'iter_max':20,'batch_size':batch_size,'div':1.0, 'beta':0.3,'rho': 0.99,'early_stop':False},
{'model':'Wang2023Better','attack':'FDMA_M1','epsilon':16.0/255,'stepsize':0.007,'iter_max':20,'batch_size':batch_size,'div':1.0,'beta':0.3,'rho': 0.99,'early_stop':False},
{'model':'Wang2023Better','attack':'FDMA_M1','epsilon':32.0/255,'stepsize':0.007,'iter_max':20,'batch_size':batch_size,'div':1.0,'beta':0.3,'rho': 0.99,'early_stop':False},
{'model':'Wang2023Better','attack':'FDMA_M2','epsilon':8.0/255 ,'stepsize':0.007,'iter_max':20,'div':1.0,'beta':0.3,'rho': 0.99,'early_stop':False,'batch_size':batch_size,'early_stop':False},
{'model':'Wang2023Better','attack':'FDMA_M2','epsilon':16.0/255,'stepsize':0.007,'iter_max':20,'div':1.0,'beta':0.3,'rho': 0.99,'early_stop':False,'batch_size':batch_size,'early_stop':False},
{'model':'Wang2023Better','attack':'FDMA_M2','epsilon':32.0/255,'stepsize':0.007,'iter_max':20,'div':1.0,'beta':0.3,'rho': 0.99,'early_stop':False,'batch_size':batch_size,'early_stop':False},
{'model':'Wang2023Better','attack':'FDMA_M1','epsilon':8.0/255 ,'stepsize':0.007,'iter_max':20,'batch_size':batch_size,'beta':0.3,'rho': 0.99,'early_stop':False},
{'model':'Wang2023Better','attack':'FDMA_M1','epsilon':16.0/255,'stepsize':0.007,'iter_max':20,'batch_size':batch_size,'beta':0.3,'rho': 0.99,'early_stop':False},
{'model':'Wang2023Better','attack':'FDMA_M1','epsilon':32.0/255,'stepsize':0.007,'iter_max':20,'batch_size':batch_size,'beta':0.3,'rho': 0.99,'early_stop':False},
{'model':'Wang2023Better','attack':'FDMA_M2','epsilon':8.0/255 ,'iter_max':20,'div':2.0,'batch_size':batch_size,'early_stop':False},
{'model':'Wang2023Better','attack':'FDMA_M2','epsilon':16.0/255,'iter_max':20,'div':2.0,'batch_size':batch_size,'early_stop':False},
{'model':'Wang2023Better','attack':'FDMA_M2','epsilon':32.0/255,'iter_max':20,'div':2.0,'batch_size':batch_size,'early_stop':False},
...
for item in list_para:
    ...
    #        # show the figure
    #        plt.show()
            adv_images=FDMA_M1(model,images,labels,epsilon=item['epsilon'],iter_max=item['iter_max'],stepsize_default=item['stepsize'],beta=item['beta'],rho=item['rho'],div=item['div'])
        ...
        for i in range(0, len(correct_index), item['batch_size']):
            ...
            #            # show the figure
            #            plt.show()
            adv_images = FDMA_M2(model, images, labels,epsilon=item['epsilon'],iter_max=item['iter_max'],stepsize_default=item['stepsize'],beta=item['beta'],rho=item['rho'],div=item['div'])
